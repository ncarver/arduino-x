...
// @5V for my Microtivity LCD, I like a 2K ohm resistor on the LCD V0 pin (VSS=gnd, VDD=pwr, A=backlite pwr, K=backlight gnd)
...
void write_lines(const char *L0, const char *L1) {
    Serial.println("write_lines");Serial.println(L0);Serial.println(L1);
    lcd.clear();
    lcd.setCursor(0, 0);
    lcd.print(L0);
    lcd.setCursor(0, 1);
