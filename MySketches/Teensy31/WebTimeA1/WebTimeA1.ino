...
//Additional function from http://cairohackerspace.blogspot.com/2011/05/beginners-guide-to-connecting-and.html
boolean initSettings() {
  Serial.println('initSettings');
  wifi.SendCommand("set wlan auth 3","AOK"); //WPA1 & WPA2
//  wifi.SendCommand("set wlan key c0c1c2c3c4c5c6c7c8c9c0cacbcc","AOK");
  wifi.SendCommand("set wlan channel 0","AOK");//perform scan
  wifi.SendCommand("set wlan join 1","AOK"); //auto join to SSID
  wifi.SendCommand("set dhcp 1","AOK"); //DHCP on
  wifi.SendCommand("save","AOK");
  wifi.SendCommand("reboot","AOK");
}
